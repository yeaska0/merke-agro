...
const DEF = {
  ...
  about:{
    year:'2004', area:'5000',
    kk:{tag:'Ферма туралы',lbl:'жылдан бері жұмыс жасаймыз',title:'Астық Мерке — табиғат пен технологияның үйлесімі',desc:'Астық Мерке — Жамбыл облысының құнарлы жерінде орналасқан ірі агрокомплекс. 2004 жылдан бері астық өсіру, мал бағу және сүт өнімдерін өндіру арқылы Қазақстан халқына таза, сапалы тағам ұсынамыз.',feats:[{i:'🌾',t:'Заманауи техника',d:'Еуропалық стандарттағы ауыл шаруашылық техникасы'},{i:'🌱',t:'Экологиялық таза өндіріс',d:'Химиялық тыңайтқышсыз, табиғи жолмен өсіру'},{i:'📜',t:'Халықаралық сертификат',d:'ISO 22000 және HACCP сертификаттары бар'},{i:'🚚',t:'Тікелей жеткізу',d:'Қазақстан бойынша тікелей жеткізу қызметі'}]},
    ru:{tag:'О ферме',lbl:'работаем с этого года',title:'Астық Мерке — гармония природы и технологий',desc:'Астық Мерке — крупный агрокомплекс на плодородных землях Жамбылской области. С 2004 года производим зерно, занимаемся животноводством и молочным производством.',feats:[{i:'🌾',t:'Современная техника',d:'Сельхозтехника европейского стандарта'},{i:'🌱',t:'Экологически чистое производство',d:'Выращивание без химических удобрений'},{i:'📜',t:'Международные сертификаты',d:'Сертификаты ISO 22000 и HACCP'},{i:'🚚',t:'Прямая доставка',d:'Служба доставки по всему Казахстану'}]},
    en:{tag:'About Farm',lbl:'operating since this year',title:'Astyk Merke — Where Nature Meets Technology',desc:'Astyk Merke is a large agro complex on the fertile lands of Zhambyl region. Since 2004 we produce grain, raise livestock and manufacture dairy products.',feats:[{i:'🌾',t:'Modern Equipment',d:'European-standard agricultural machinery'},{i:'🌱',t:'Eco-Friendly Production',d:'Grown without chemical fertilizers'},{i:'📜',t:'International Certifications',d:'ISO 22000 and HACCP certified'},{i:'🚚',t:'Direct Delivery',d:'Delivery service across Kazakhstan'}]},
  },
  stats:[
  ...
  contact:{
    ...
    addr_ru:'Жамбылская область, район Мерке, комплекс Астық Мерке',
    addr_en:'Zhambyl Region, Merke District, Astyk Merke Complex',
  ...
  siteSettings:{
    ...
    footerDesc_kk:'Қазақстандағы ең ірі агро кешендерінің бірі. Табиғи өнімдер, заманауи технология.',
    footerDesc_ru:'Один из крупнейших агрокомплексов Казахстана. Натуральные продукты, современные технологии.',
    footerDesc_en:"One of Kazakhstan's largest agro complexes. Natural products, modern technology.",
  },
};